+++
updated = 2025-12-14T17:26:00+01:00
title = "2025-12-14 Daily Challenge"
path = "2025-12-14-Daily-Challenge"
date = 2025-12-14T17:26:00+01:00
...
Today I have done leetcode's [December LeetCoding Challenge](https://leetcode.com/problems/number-of-ways-to-divide-a-long-corridor/) with `cpp`.
...
public:
  int numberOfWays(string corridor) {
    ...
    while(pos < corridor.length()) {
      ...
      seatCount = 0;
      int plantCount = 0;
      while(pos < corridor.length() && corridor[pos] == 'P') {
        plantCount += 1;
        pos += 1;
      }
      if(pos < corridor.length()) ways = 1LL * (plantCount + 1) * ways % MOD;
    }
    return ways;
  }
};
...
// Accepted
// 248/248 cases passed (59 ms)
// Your runtime beats 100 % of cpp submissions
// Your memory usage beats 100 % of cpp submissions (30.8 MB)
```
