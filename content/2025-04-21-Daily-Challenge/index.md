+++
updated = 2025-04-21T13:27:02+08:00
title = "2025-04-21 Daily Challenge"
path = "2025-04-21-Daily-Challenge"
date = 2025-04-22T13:27:02+08:00
...
Today I have done leetcode's [April LeetCoding Challenge](https://leetcode.com/problems/count-the-hidden-sequences/) with `cpp`.
...
public:
  int numberOfArrays(vector<int>& differences, int lower, int upper) {
    ...
    return max<long long>(0, (upper - lower) - (highest - lowest) + 1);
  }
};

// Accepted
// 86/86 cases passed (2 ms)
// Your runtime beats 42.19 % of cpp submissions
// Your memory usage beats 16.41 % of cpp submissions (112.7 MB)
```
