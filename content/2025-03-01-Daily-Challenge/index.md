+++
updated = 2025-03-01T23:54:08+08:00
title = "2025-03-01 Daily Challenge"
path = "2025-03-01-Daily-Challenge"
date = 2025-03-01T23:54:08+08:00
...
Today I have done leetcode's [March LeetCoding Challenge](https://leetcode.com/problems/apply-operations-to-an-array/) with `cpp`.
  ...
  vector<int> applyOperations(vector<int>& nums) {
    ...
    for(int i = 0; i < nums.size(); ++i) {
      if(pos >= nums.size()) {
        ...
        while(pos < nums.size() && !nums[pos]) {
          pos += 1;
        }
        nums[i] = pos == nums.size() ? 0 : nums[pos++];
      }
    }
    return nums;
  }
...
// Your memory usage beats 87.59 % of cpp submissions (13.1 MB)
```
