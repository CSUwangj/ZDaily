+++
updated = 2024-07-03T10:24:34+08:00
title = "2024-07-03 Daily Challenge"
path = "2024-07-03-Daily-Challenge"
date = 2024-07-03T10:24:34+08:00
...
Today I have done leetcode's [July LeetCoding Challenge](https://leetcode.com/problems/minimum-difference-between-largest-and-smallest-value-in-three-moves/) with `cpp`.
...
public:
  int minDifference(vector<int>& nums) {
    ...
    return min({nums[len - 4] - nums[0], nums[len - 3] - nums[1], nums[len - 2] - nums[2], nums[len - 1] - nums[3]});
  }
};
```
