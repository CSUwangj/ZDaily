+++
updated = 2024-04-08T14:27:44+08:00
title = "2024-04-08 Daily Challenge"
path = "2024-04-08-Daily-Challenge"
date = 2024-04-08T14:27:44+08:00
...
Today I have done leetcode's [April LeetCoding Challenge](https://leetcode.com/problems/number-of-students-unable-to-eat-lunch/) with `cpp`.
...
public:
  int countStudents(vector<int>& students, vector<int>& sandwiches) {
    ...
    for(int i = 0; i < sandwiches.size(); ++i) {
      if(!types[sandwiches[i]]) {
        return sandwiches.size() - i;
      }
      types[sandwiches[i]] -= 1;
    }
    return 0;
  }
};
