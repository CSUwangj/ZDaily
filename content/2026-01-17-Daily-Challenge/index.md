+++
updated = 2026-01-17T22:46:24+01:00
title = "2026-01-17 Daily Challenge"
path = "2026-01-17-Daily-Challenge"
date = 2026-01-17T22:46:24+01:00
...
Today I have done leetcode's [January LeetCoding Challenge](https://leetcode.com/problems/find-the-largest-area-of-square-inside-two-rectangles/) with `cpp`.
...
<img alt="" style="width: 443px; height: 364px; padding: 10px; background: rgb(255, 255, 255); border-radius: 0.5rem;" src="https://assets.leetcode.com/uploads/2024/01/05/example12.png">
...
<img alt="" style="width: 451px; height: 470px; padding: 10px; background: rgb(255, 255, 255); border-radius: 0.5rem;" src="https://assets.leetcode.com/uploads/2024/07/15/diag.png">
...
<code> <img alt="" style="padding: 10px; background: rgb(255, 255, 255); border-radius: 0.5rem; width: 445px; height: 365px;" src="https://assets.leetcode.com/uploads/2024/01/04/rectanglesexample2.png"> </code>
...
<code> <img alt="" style="padding: 10px; background: rgb(255, 255, 255); border-radius: 0.5rem; width: 444px; height: 364px;" src="https://assets.leetcode.com/uploads/2024/01/04/rectanglesexample3.png"> </code>
...
// Accepted
// 661/661 cases passed (107 ms)
// Your runtime beats 57.52 % of cpp submissions
// Your memory usage beats 77.39 % of cpp submissions (59.4 MB)
```
