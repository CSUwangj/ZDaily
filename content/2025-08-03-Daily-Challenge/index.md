+++
updated = 2025-08-04T04:09:43+08:00
title = "2025-08-03 Daily Challenge"
path = "2025-08-03-Daily-Challenge"
date = 2025-08-04T04:09:43+08:00
...
Today I have done leetcode's [August LeetCoding Challenge](https://leetcode.com/problems/maximum-fruits-harvested-after-at-most-k-steps/) with `cpp`.
...
public:
  int maxTotalFruits(vector<vector<int>>& fruits, int startPos, int k) {
    ...
    int current = 0;
    while(right < len) {
      current += fruits[right][1];
      while(left <= right && fruits[right][0] - fruits[left][0] + min(abs(fruits[left][0] - startPos), abs(fruits[right][0] - startPos)) > k) {
...
// Accepted
// 202/202 cases passed (7 ms)
// Your runtime beats 63.41 % of cpp submissions
// Your memory usage beats 84.96 % of cpp submissions (124.4 MB)
```
