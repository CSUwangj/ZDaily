+++
updated = 2024-05-27T09:53:03+08:00
title = "2024-05-27 Daily Challenge"
path = "2024-05-27-Daily-Challenge"
date = 2024-05-27T09:53:03+08:00
...
Today I have done leetcode's [May LeetCoding Challenge](https://leetcode.com/problems/special-array-with-x-elements-greater-than-or-equal-x/) with `cpp`.
...
public:
  int specialArray(vector<int>& nums) {
    ...
    for(int i = 0; i < nums.size(); ++i) {
      if(nums[i] >= i + 1 && (i + 1 >= nums.size() || nums[i + 1] < i + 1)) return i + 1;
    }
    return -1;
  }
};
