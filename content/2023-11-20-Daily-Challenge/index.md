+++
updated = 2023-11-20T17:26:46+08:00
title = "2023-11-20 Daily Challenge"
path = "2023-11-20-Daily-Challenge"
date = 2023-11-20T17:26:46+08:00
...
Today I have done leetcode's [November LeetCoding Challenge](https://leetcode.com/problems/minimum-amount-of-time-to-collect-garbage/) with `cpp`.
...
public:
  int garbageCollection(vector<string>& garbage, vector<int>& travel) {
    map<char, int> furtherestGarbages;
    ...
    for(int i = 0; i < garbage.size(); ++i) {
      ...
      for(auto c : garbage[i]) {
        furtherestGarbages[c] = i;
      }
    }
    
    for(const auto &[_garbage, location] : furtherestGarbages) {
      answer += travel[location];
    }
    return answer;
  }
};
...
// Accepted
// 75/75 cases passed (169 ms)
// Your runtime beats 59.2 % of cpp submissions
// Your memory usage beats 99.6 % of cpp submissions (102.3 MB)
```
