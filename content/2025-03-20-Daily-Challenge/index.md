+++
updated = 2025-03-20T13:18:24+08:00
title = "2025-03-20 Daily Challenge"
path = "2025-03-20-Daily-Challenge"
date = 2025-03-20T13:18:24+08:00
...
Today I have done leetcode's [March LeetCoding Challenge](https://leetcode.com/problems/minimum-cost-walk-in-weighted-graph/) with `cpp`.
...
struct UnionSet {
  ...
  vector<int> minCost;
public:
  UnionSet(int size): parent(size), minCost(size, -1) {
...
public:
  vector<int> minimumCost(int n, vector<vector<int>>& edges, vector<vector<int>>& query) {
    ...
    for(auto &e : edges) {
      us.merge(e[0], e[1], e[2]);
    }

    vector<int> answer;
    answer.reserve(query.size());
    for(auto &q : query) {
      answer.push_back(us.get(q[0], q[1]));
    } 
    return answer;
  }
};
...
// Accepted
// 548/548 cases passed (17 ms)
// Your runtime beats 94.55 % of cpp submissions
// Your memory usage beats 61.69 % of cpp submissions (208.3 MB)
```
