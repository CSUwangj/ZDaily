+++
updated = 2025-02-07T23:48:11+08:00
title = "2025-02-07 Daily Challenge"
path = "2025-02-07-Daily-Challenge"
date = 2025-02-07T23:48:11+08:00
...
Today I have done leetcode's [February LeetCoding Challenge](https://leetcode.com/problems/find-the-number-of-distinct-colors-among-the-balls/) with `cpp`.
...
public:
  vector<int> queryResults(int limit, vector<vector<int>>& queries) {
    map<int, int> ball2Color;
    map<int, set<int>> color2Balls;
    vector<int> answer;
    answer.reserve(queries.size());
    for(auto &q : queries) {
      if(ball2Color.count(q[0])) {
        color2Balls[ball2Color[q[0]]].erase(q[0]);
        if(color2Balls[ball2Color[q[0]]].empty()) color2Balls.erase(ball2Color[q[0]]);
      }
      color2Balls[q[1]].insert(q[0]);
      ball2Color[q[0]] = q[1];
...
// Accepted
// 551/551 cases passed (460 ms)
// Your runtime beats 5.15 % of cpp submissions
// Your memory usage beats 5.79 % of cpp submissions (194.4 MB)
```
