+++
updated = 2024-04-25T19:44:53+08:00
title = "2024-04-25 Daily Challenge"
path = "2024-04-25-Daily-Challenge"
date = 2024-04-25T19:44:53+08:00
...
Today I have done leetcode's [April LeetCoding Challenge](https://leetcode.com/problems/longest-ideal-subsequence/) with `cpp`.
...
public:
  int longestIdealString(string s, int k) {
    ...
    for(auto c : s) {
      int i = c - 'a';
      dp[i] = dp[i] + 1;
      for(int a = max(0, i - k); a < min(26, i + k + 1); ++a) {
        if(a == i) continue;
