+++
updated = 2024-07-09T18:48:25+08:00
title = "2024-07-09 Daily Challenge"
path = "2024-07-09-Daily-Challenge"
date = 2024-07-09T18:48:25+08:00
...
Today I have done leetcode's [July LeetCoding Challenge](https://leetcode.com/problems/average-waiting-time/) with `cpp`.
...
public:
  double averageWaitingTime(vector<vector<int>>& customers) {
    double totalTime = 0;
    int currentTime = customers.front()[0];
    ...
    return totalTime * 1.0 / customers.size();
  }
};
```
