+++
updated = 2024-10-19T08:07:30+08:00
title = "2024-10-19 Daily Challenge"
path = "2024-10-19-Daily-Challenge"
date = 2024-10-19T08:07:30+08:00
...
Today I have done leetcode's [October LeetCoding Challenge](https://leetcode.com/problems/find-kth-bit-in-nth-binary-string/) with `cpp`.
...
public:
  char findKthBit(int n, int k) {
    if(n == 1) return '0';
    int midBit = 1 << (n - 1);
    if(k < midBit) return findKthBit(n - 1, k);
    if(k == midBit) return '1';
    return 1 ^ findKthBit(n - 1, 2 * midBit - k); //if (k > midBit)) 
  }
};
```
