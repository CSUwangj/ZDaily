+++
updated = 2024-11-08T09:45:55+08:00
title = "2024-11-08 Daily Challenge"
path = "2024-11-08-Daily-Challenge"
date = 2024-11-08T09:45:55+08:00
...
Today I have done leetcode's [November LeetCoding Challenge](https://leetcode.com/problems/maximum-xor-for-each-query/) with `cpp`.
...
public:
  vector<int> getMaximumXor(vector<int>& nums, int maximumBit) {
    int spliter = (1 << maximumBit);
    int xorSum = accumulate(nums.begin(), nums.end(), 0, [](int a, int b){ return a ^ b; });

    vector<int> answer;
    answer.reserve(nums.size());
    for(int i = 0; i < nums.size(); ++i) {
      answer.push_back((xorSum % spliter) ^ (spliter - 1));
