+++
updated = 2025-05-16T00:30:23+08:00
title = "2025-05-15 Daily Challenge"
path = "2025-05-15-Daily-Challenge"
date = 2025-05-16T00:30:23+08:00
...
Today I have done leetcode's [May LeetCoding Challenge](https://leetcode.com/problems/longest-unequal-adjacent-groups-subsequence-i/) with `cpp`.
...
public:
  vector<string> getLongestSubsequence(vector<string>& words, vector<int>& groups) {
    vector<string> answer(words.begin(), words.begin() + 1);
...
// Your memory usage beats 40.56 % of cpp submissions (30 MB)
```
