+++
updated = 2025-10-08T00:05:01+02:00
title = "2025-10-07 Daily Challenge"
path = "2025-10-07-Daily-Challenge"
date = 2025-10-08T00:05:01+02:00
...
Today I have done leetcode's [October LeetCoding Challenge](https://leetcode.com/problems/avoid-flood-in-the-city/) with `cpp`.
...
public:
  vector<int> avoidFlood(vector<int>& rains) {
    ...
    for(int i = 0; i < len; ++i) {
      ...
      answer[i] = -1;
      if(lastRainy.count(rains[i])) {
        auto it = dry.lower_bound(lastRainy[rains[i]]);
...
// Accepted
// 82/82 cases passed (187 ms)
// Your runtime beats 21.94 % of cpp submissions
// Your memory usage beats 23.36 % of cpp submissions (117.1 MB)
```
