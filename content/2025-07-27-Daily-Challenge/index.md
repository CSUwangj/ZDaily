+++
updated = 2025-07-28T01:13:44+08:00
title = "2025-07-27 Daily Challenge"
path = "2025-07-27-Daily-Challenge"
date = 2025-07-28T01:13:44+08:00
...
Today I have done leetcode's [July LeetCoding Challenge](https://leetcode.com/problems/count-hills-and-valleys-in-an-array/) with `cpp`.
...
public:
  int countHillValley(vector<int>& nums) {
    ...
    for(int i = 1; i < nums.size(); ++i) {
      int curSign = sgn(nums[i] - nums[i - 1]);
      if(!curSign || curSign == prevSign) continue;
      answer += !!prevSign;
      prevSign = curSign;
    }
    return answer;
...
// Your memory usage beats 50.25 % of cpp submissions (12.1 MB)
```
