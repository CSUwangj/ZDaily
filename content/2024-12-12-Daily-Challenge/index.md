+++
updated = 2024-12-12T21:27:10+08:00
title = "2024-12-12 Daily Challenge"
path = "2024-12-12-Daily-Challenge"
date = 2024-12-12T21:27:10+08:00
...
Today I have done leetcode's [December LeetCoding Challenge](https://leetcode.com/problems/take-gifts-from-the-richest-pile/) with `cpp`.
...
public:
  long long pickGifts(vector<int>& gifts, int k) {
    ...
    while(k-- && pq.top() != 1) {
      int current = pq.top();
      pq.pop();
      int remain = floor(sqrt(current));
      answer -= current - remain;
      pq.push(remain);
    }
    return answer;
  }
