+++
updated = 2025-02-08T15:47:01+08:00
title = "2025-02-08 Daily Challenge"
path = "2025-02-08-Daily-Challenge"
date = 2025-02-08T15:47:01+08:00
...
Today I have done leetcode's [February LeetCoding Challenge](https://leetcode.com/problems/design-a-number-container-system/) with `cpp`.
...
public:
  ...
  void change(int index, int number) {
    if(numbers.count(index)) {
      indice[numbers[index]].erase(index);
    }
    indice[number].insert(index);
    numbers[index] = number;
  }
  
  int find(int number) {
    if(indice[number].empty()) return -1;
    return *indice[number].begin();
  }
};

// Accepted
// 45/45 cases passed (163 ms)
// Your runtime beats 8.66 % of cpp submissions
// Your memory usage beats 6.27 % of cpp submissions (198.1 MB)
```
