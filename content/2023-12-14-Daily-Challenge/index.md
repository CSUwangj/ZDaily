+++
updated = 2023-12-14T10:00:44+08:00
title = "2023-12-14 Daily Challenge"
path = "2023-12-14-Daily-Challenge"
date = 2023-12-14T10:00:44+08:00
...
Today I have done leetcode's [December LeetCoding Challenge](https://leetcode.com/problems/difference-between-ones-and-zeros-in-row-and-column/) with `cpp`.
...
public:
  vector<vector<int>> onesMinusZeros(vector<vector<int>>& grid) {
    ...
    vector<int> oneInRow(rows);
    vector<int> oneInCol(cols);
    ...
    for(int i = 0; i < rows; ++i) {
      for(int j = 0; j < cols; ++j) {
        answer[i][j] = 2 * oneInRow[i] - rows + 2 * oneInCol[j] - cols;
      }
    }
...
// Accepted
// 85/85 cases passed (195 ms)
// Your runtime beats 61.52 % of cpp submissions
// Your memory usage beats 83.97 % of cpp submissions (117.4 MB)
```
