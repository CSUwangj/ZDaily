+++
updated = 2024-02-15T16:21:54+08:00
title = "2024-02-15 Daily Challenge"
path = "2024-02-15-Daily-Challenge"
date = 2024-02-15T16:21:54+08:00
...
Today I have done leetcode's [February LeetCoding Challenge](https://leetcode.com/problems/find-polygon-with-the-largest-perimeter/) with `cpp`.
...
public:
  long long largestPerimeter(vector<int>& nums) {
    ...
    if(answer <= nums[0] + nums[1]) return -1;
    return answer;
  }
};

// Accepted
// 980/980 cases passed (133 ms)
