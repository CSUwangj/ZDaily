+++
updated = 2024-09-07T08:44:11+08:00
title = "2024-09-07 Daily Challenge"
path = "2024-09-07-Daily-Challenge"
date = 2024-09-07T08:44:11+08:00
...
Today I have done leetcode's [September LeetCoding Challenge](https://leetcode.com/problems/linked-list-in-binary-tree/) with `cpp`.
...
class Solution {
public:
  bool isSubPath(ListNode* head, TreeNode* root, ListNode *cur = nullptr, bool first = true) {
    if(!first && !cur) return true;
    ...
    return isSubPath(head, root->left, cur, false) || isSubPath(head, root->right, cur, false);
  }
};
```
