+++
updated = 2025-04-25T19:25:40+08:00
title = "2025-04-25 Daily Challenge"
path = "2025-04-25-Daily-Challenge"
date = 2025-04-25T19:25:40+08:00
...
Today I have done leetcode's [April LeetCoding Challenge](https://leetcode.com/problems/count-of-interesting-subarrays/) with `cpp`.
...
public:
  long long countInterestingSubarrays(vector<int>& nums, int modulo, int k) {
    ...
    for(auto n : nums) {
      ...
      answer += count[(current - k + modulo) % modulo];
      count[current] += 1;
    }
...
// Accepted
// 617/617 cases passed (107 ms)
// Your runtime beats 13.66 % of cpp submissions
// Your memory usage beats 26.78 % of cpp submissions (124.1 MB)
```
