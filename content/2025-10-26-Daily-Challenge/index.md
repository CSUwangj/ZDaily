+++
updated = 2025-10-26T18:49:12+01:00
title = "2025-10-26 Daily Challenge"
path = "2025-10-26-Daily-Challenge"
date = 2025-10-26T18:49:12+01:00
...
Today I have done leetcode's [October LeetCoding Challenge](https://leetcode.com/problems/simple-bank-system/) with `cpp`.
...
public:
  ...
  bool transfer(int account1, int account2, long long money) {
    account1 -= 1;
    account2 -= 1;
    if(account1 < 0 || account2 < 0 || account1 >= n || account2 >= n) return false;
...
// Your runtime beats 58.88 % of cpp submissions
// Your memory usage beats 30.79 % of cpp submissions (123.7 MB)
```
